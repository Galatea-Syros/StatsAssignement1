...
cat("Both samples are of N>50 but none seems to be normally distributed nor symmetrical enough for the average to be a decent estimator of therefore we will check for differences between the medians using a Wilcoxon rank sum test")
